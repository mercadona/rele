...
# Maps each deprecated hook to the hook that replaces it, so the warning
# message can name the right pair instead of hard-coding "post_publish".
DEPRECATED_HOOKS: dict[str, str] = {"post_publish": "post_publish_success"}
